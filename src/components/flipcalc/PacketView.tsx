          ...
          <div className="flex-1 overflow-auto rounded-3xl border border-white/12 bg-[#0b0b10]/90 shadow-[0_30px_120px_rgba(0,0,0,0.6)] print:border-0 print:bg-white print:text-black">
            <div className="sticky top-0 z-10 flex flex-col gap-3 border-b border-white/10 bg-[#0b0b10]/95 px-5 py-4 backdrop-blur print:hidden sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <div className="mt-1 text-lg font-semibold text-white/90">{p.address}</div>
                <div className="text-sm text-white/60">{p.cityState}</div>
              </div>
              <div className="flex flex-col gap-2 sm:flex-row">
                <NeonButton variant="ghost" onClick={onClose} className="w-full justify-center text-xs">
                  CLOSE
                </NeonButton>
                <NeonButton variant="primary" onClick={() => window.print()} className="w-full justify-center text-xs">
                  PRINT / SAVE PDF
                </NeonButton>
              </div>
            </div>
            ...
            <div className="space-y-5 px-5 pb-6 pt-4 print:px-6">
              <div className="rounded-2xl border border-white/10 bg-black/20 p-5 print:border-[#ddd] print:bg-white">
              ...
              <div className="rounded-2xl border border-white/10 bg-black/20 p-5 text-sm text-white/80 print:border-[#ddd] print:bg-white print:text-black">
                <div className="font-semibold text-white/90 print:text-black">Rehab line items</div>
                <div className="mt-2 space-y-1">
              ...
              <div className="text-xs text-white/45 print:hidden">
